...
#ifndef EVALUTATION_COFACTOR_HPP
#define EVALUTATION_COFACTOR_HPP


#include <lifev/core/LifeV.hpp>

#include <lifev/eta/array/OperationSmallCofactor.hpp>
...
public:
    ...
    typedef typename OperationSmallCofactor< typename EvaluationType::return_Type >::result_Type return_Type;
    ...
    //! Copy constructor
    EvaluationCofactor (const EvaluationCofactor& eval)
        : M_evaluation (eval.M_evaluation)
    {}

    //! Constructor from the corresponding expression
    template< typename Expression>
    explicit EvaluationCofactor (const ExpressionCofactor<Expression>& expression)
    ...
    {
        return M_evaluation.value_q (q).cofactor();
    }

    //! Getter for the value for a vector
    return_Type value_qi (const UInt& q, const UInt& i) const
    {
        return M_evaluation.value_qi (q, i).cofactor();
    }

    //! Getter for the value for a matrix
    return_Type value_qij (const UInt& q, const UInt& i, const UInt& j) const
    {
        return M_evaluation.value_qij (q, i, j).cofactor();
    }
...
template< typename EvaluationType >
const flag_Type EvaluationCofactor<EvaluationType>::S_globalUpdateFlag
    = EvaluationType::S_globalUpdateFlag;

template< typename EvaluationType >
const flag_Type EvaluationCofactor<EvaluationType>::S_testUpdateFlag
    = EvaluationType::S_testUpdateFlag;

template< typename EvaluationType >
const flag_Type EvaluationCofactor<EvaluationType>::S_solutionUpdateFlag
