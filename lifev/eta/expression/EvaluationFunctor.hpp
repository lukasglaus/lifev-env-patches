...
//! Evaluation for a generic functor with 3 arguments
/*!
  @author Simone Rossi <simone.rossi@epfl.ch>

  This class aims at representing a functor with 3 arguements during the assembly
 ...
 */
template <typename FunctorType, typename Argument1EvaluationType, typename Argument2EvaluationType, typename Argument3EvaluationType>
class EvaluationFunctor3
{
public:
    ...
    //! Copy constructor
    EvaluationFunctor3 (const EvaluationFunctor3<FunctorType, Argument1EvaluationType, Argument2EvaluationType, Argument3EvaluationType>& eval)
        : M_functor (eval.M_functor),
          M_evaluation1 (eval.M_evaluation1),
          M_evaluation2 (eval.M_evaluation2),
    ...
    explicit EvaluationFunctor3 (const ExpressionFunctor3<FunctorType, Argument1, Argument2, Argument3>& expression)
        : M_functor (expression.functor() ),
          M_evaluation1 (expression.argument1() ),
          M_evaluation2 (expression.argument2() ),
          M_evaluation3 (expression.argument3() ) {}
    ...
    static void display (std::ostream& out = std::cout)
    {
        ...
        Argument2EvaluationType::display (out);
        out << " , ";
        Argument3EvaluationType::display (out);
        out << " )";
    }
    ...
    return_Type value_q (const UInt& q) const
    {
        return (*M_functor) (M_evaluation1.value_q (q), M_evaluation2.value_q (q), M_evaluation3.value_q (q) );
    }

    //! Getter for the value for a vector
    return_Type value_qi (const UInt& q, const UInt& i) const
    {
        return (*M_functor) (M_evaluation1.value_qi (q, i), M_evaluation2.value_qi (q, i), M_evaluation3.value_qi (q, i) );
    }

    //! Getter for the value for a matrix
    return_Type value_qij (const UInt& q, const UInt& i, const UInt& j) const
    {
        return (*M_functor) (M_evaluation1.value_qij (q, i, j), M_evaluation2.value_qij (q, i, j), M_evaluation3.value_qij (q, i, j) );
    }
...
private:
    ...
    Argument1EvaluationType M_evaluation1;
    Argument2EvaluationType M_evaluation2;
    Argument3EvaluationType M_evaluation3;
};


template<typename FunctorType, typename Argument1EvaluationType, typename Argument2EvaluationType, typename Argument3EvaluationType>
const flag_Type EvaluationFunctor3<FunctorType, Argument1EvaluationType, Argument2EvaluationType, Argument3EvaluationType>::S_globalUpdateFlag
    = Argument1EvaluationType::S_globalUpdateFlag | Argument2EvaluationType::S_globalUpdateFlag | Argument3EvaluationType::S_globalUpdateFlag;

template<typename FunctorType, typename Argument1EvaluationType, typename Argument2EvaluationType, typename Argument3EvaluationType>
const flag_Type EvaluationFunctor3<FunctorType, Argument1EvaluationType, Argument2EvaluationType, Argument3EvaluationType>::S_testUpdateFlag
    = Argument1EvaluationType::S_testUpdateFlag | Argument2EvaluationType::S_testUpdateFlag | Argument3EvaluationType::S_testUpdateFlag;

template<typename FunctorType, typename Argument1EvaluationType, typename Argument2EvaluationType, typename Argument3EvaluationType>
const flag_Type EvaluationFunctor3<FunctorType, Argument1EvaluationType, Argument2EvaluationType, Argument3EvaluationType>::S_solutionUpdateFlag
    = Argument1EvaluationType::S_solutionUpdateFlag | Argument2EvaluationType::S_solutionUpdateFlag | Argument3EvaluationType::S_solutionUpdateFlag;
    ...
    //! Evaluation for a generic functor with 4 arguments
    /*!
     @author Simone Rossi <simone.rossi@epfl.ch>
    ...
    public:
        ...
        //! Copy constructor
        EvaluationFunctor4 (const EvaluationFunctor4<FunctorType, Argument1EvaluationType, Argument2EvaluationType, Argument3EvaluationType, Argument4EvaluationType>& eval)
        : M_functor (eval.M_functor),
        M_evaluation1 (eval.M_evaluation1),
        M_evaluation2 (eval.M_evaluation2),
        M_evaluation3 (eval.M_evaluation3),
        M_evaluation4 (eval.M_evaluation4)
        {}
        
        //! Constructor from the corresponding expression
        template<typename Argument1, typename Argument2, typename Argument3, typename Argument4>
        explicit EvaluationFunctor4 (const ExpressionFunctor4<FunctorType, Argument1, Argument2, Argument3, Argument4>& expression)
        : M_functor (expression.functor() ),
        M_evaluation1 (expression.argument1() ),
        M_evaluation2 (expression.argument2() ),
        M_evaluation3 (expression.argument3() ),
        M_evaluation4 (expression.argument4() ) {}
        ...
        static void display (std::ostream& out = std::cout)
        {
            ...
            Argument3EvaluationType::display (out);
            out << " )";
            Argument4EvaluationType::display (out);
            out << " )";
        }
        ...
        void setGlobalCFE (const CFEType* globalCFE)
        {
            ...
            M_evaluation2.setGlobalCFE (globalCFE);
            M_evaluation3.setGlobalCFE (globalCFE);
            M_evaluation4.setGlobalCFE (globalCFE);
        }
        ...
        void setTestCFE (const CFEType* testCFE)
        {
            ...
            M_evaluation2.setTestCFE (testCFE);
            M_evaluation3.setTestCFE (testCFE);
            M_evaluation4.setTestCFE (testCFE);
        }
        ...
        void setSolutionCFE (const CFEType* solutionCFE)
        {
            ...
            M_evaluation2.setSolutionCFE (solutionCFE);
            M_evaluation3.setSolutionCFE (solutionCFE);
            M_evaluation4.setSolutionCFE (solutionCFE);
        }
        ...
        void setQuadrature (const QuadratureRule& qr)
        {
            ...
            M_evaluation2.setQuadrature (qr);
            M_evaluation3.setQuadrature (qr);
            M_evaluation4.setQuadrature (qr);
        }
        ...
        return_Type value_q (const UInt& q) const
        {
            return (*M_functor) (M_evaluation1.value_q (q), M_evaluation2.value_q (q), M_evaluation3.value_q (q), M_evaluation4.value_q (q) );
        }
        
        //! Getter for the value for a vector
        return_Type value_qi (const UInt& q, const UInt& i) const
        {
            return (*M_functor) (M_evaluation1.value_qi (q, i), M_evaluation2.value_qi (q, i), M_evaluation3.value_qi (q, i),  M_evaluation4.value_qi (q, i) );
        }
        
        //! Getter for the value for a matrix
        return_Type value_qij (const UInt& q, const UInt& i, const UInt& j) const
        {
            return (*M_functor) (M_evaluation1.value_qij (q, i, j), M_evaluation2.value_qij (q, i, j), M_evaluation3.value_qij (q, i, j), M_evaluation4.value_qij (q, i, j) );
        }
    ...
    private:
        ...
        Argument2EvaluationType M_evaluation2;
        Argument3EvaluationType M_evaluation3;
        Argument4EvaluationType M_evaluation4;
    };
    ...
    template<typename FunctorType, typename Argument1EvaluationType, typename Argument2EvaluationType, typename Argument3EvaluationType>, typename Argument4EvaluationType>
    const flag_Type EvaluationFunctor3<FunctorType, Argument1EvaluationType, Argument2EvaluationType, Argument3EvaluationType, Argument4EvaluationType>::S_testUpdateFlag
    ...
    template<typename FunctorType, typename Argument1EvaluationType, typename Argument2EvaluationType, typename Argument3EvaluationType>, typename Argument4EvaluationType>
    const flag_Type EvaluationFunctor3<FunctorType, Argument1EvaluationType, Argument2EvaluationType, Argument3EvaluationType, Argument4EvaluationType>::S_solutionUpdateFlag
