...
// Solver
#include <lifev/em/solver/EMMixedSolver.hpp>
...
//    feenableexcept(FE_INVALID | FE_OVERFLOW);
    ...
    typedef MixedStructuralOperator< mesh_Type >            physicalSolver_Type;
    ...
    EMMixedSolver<mesh_Type, monodomain_Type> solver(comm);
