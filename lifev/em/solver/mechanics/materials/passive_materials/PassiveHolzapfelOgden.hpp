...
PassiveHolzapfelOgden<Mesh>::PassiveHolzapfelOgden() :
    super ("Passive Holzapfel Ogden", 8)
{
    ...
    this -> M_materialFunctionList[6].reset (
    		new MaterialFunctions::AnisotropicExponential<Mesh> ( 25640.0,
																  10.446,
																  MaterialFunctions::AnisotropicExponential<Mesh>::Sheets )  );
    this -> M_materialFunctionList[7].reset (
    		new MaterialFunctions::dAnisotropicExponential<Mesh> ( 25640.0,
    															   10.446,
    															   MaterialFunctions::AnisotropicExponential<Mesh>::Sheets )  );
