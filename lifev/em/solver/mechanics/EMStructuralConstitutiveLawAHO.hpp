...
//            }
    ...
    public:
        ...
        return_Type operator() (const LifeV::MatrixSmall<3,3>& F, const LifeV::MatrixSmall<3,3>& FAinv, const LifeV::MatrixSmall<3,3>& dphij, const LifeV::VectorSmall<3>& f0)
        {
