...
//! Constructors
// ===================================================
EMIonicAlievPanfilov::EMIonicAlievPanfilov()    :
    super       ( 2   ),
    M_mu1       ( 0.12 ),
    M_mu2       ( 0.3 ),
    M_k         ( 8.0 ),
...
EMIonicAlievPanfilov::EMIonicAlievPanfilov ( Teuchos::ParameterList& parameterList   )   :
    super       ( 2 )
{
...
EMIonicAlievPanfilov::EMIonicAlievPanfilov ( const EMIonicAlievPanfilov& model )
{
...
//! Operator
// ===================================================
EMIonicAlievPanfilov& EMIonicAlievPanfilov::operator= ( const EMIonicAlievPanfilov& model )
{
    M_mu1       =  model.M_mu1;
    M_mu2       =  model.M_mu2;
    M_k         =  model.M_k;
...
Real EMIonicAlievPanfilov::computeLocalPotentialRhs ( const std::vector<Real>& v )
{
    return ( - M_k * v[0] * ( v[0] - M_a ) * ( v[0] - 1.0) - v[0] * v[1] );
}


void EMIonicAlievPanfilov::showMe()
{
